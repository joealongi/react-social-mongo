![React Social Mongo](https://raw.githubusercontent.com/joealongi/react-social-mongo/master/public/react-social-mongo_image.png)

# React Social Mongo

![Version](https://img.shields.io/badge/version-1.0.0-blue.svg?cacheSeconds=2592000) [![License: MIT ](https://img.shields.io/badge/License-MIT-green.svg)](https://github.com/joealongi/react-social-mongo/blob/master/LICENSE) ![GitHub stars](https://img.shields.io/github/stars/joealongi/react-social-mongo?style=social) ![Twitter Follow](https://img.shields.io/twitter/follow/joealongi?label=Follow&style=social)
...
- **Option 1.)** [Download the latest version of this template from GitHub](https://github.com/joealongi/react-social-mongo/archive/master.zip)

- **Option 2.)** Clone this repository

```

git clone https://github.com/joealongi/react-social-mongo.git

```

- **Option 3.)** [Fork, Clone, or Download via GitHub Desktop](x-github-client://openRepo/https://github.com/joealongi/react-social-mongo)
...
[Clone Repo](x-github-client://openRepo/https://github.com/joealongi/react-social-mongo)
...
Having an issue with the template? Report bugs & issues with Purple on GitHub via [Issues](https://github.com/joealongi/react-social-mongo/issues). Fork, Pull, or Send an email over to join as a contributor! Join in on the open source conversation on [X](https://x.com/joealongi).
...
© 2020 React Social Mongo released via [MIT](https://opensource.org/licenses/MIT) license. Information on this license can be viewed as it applies to this repository on GitHub at [React Social Mongo License](https://github.com/joealongi/react-social-mongo/blob/master/LICENSE).
